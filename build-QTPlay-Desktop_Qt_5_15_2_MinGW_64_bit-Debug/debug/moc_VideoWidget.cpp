...
QT_MOC_LITERAL(5, 39, 9), // "VideoData"
QT_MOC_LITERAL(6, 49, 6), // "uchar*"
QT_MOC_LITERAL(7, 56, 4), // "data"
QT_MOC_LITERAL(8, 61, 8) // "TimeData"

    },
    "VideoWidget\0SendTimeData\0\0int64_t\0"
    "time\0VideoData\0uchar*\0data\0TimeData"
};
...
void VideoWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->VideoData((*reinterpret_cast< uchar*(*)>(_a[1]))); break;
        case 2: _t->TimeData((*reinterpret_cast< int64_t(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (VideoWidget::*)(int64_t );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoWidget::SendTimeData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VideoWidget::SendTimeData(int64_t _t1)
{
